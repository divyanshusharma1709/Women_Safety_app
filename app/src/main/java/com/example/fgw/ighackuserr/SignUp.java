...
public class SignUp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference=mDatabase.getReference("User_females");
    }
    ...
    public void setSignupa()
    {
        ...
        final String identitymno = identitynumber.getText().toString();
...
//                progressBar.setVisibility (View.GONE);
                if(task.isSuccessful ()) {
                    ...
                    Toast.makeText(getApplicationContext(),identitymno,Toast.LENGTH_LONG).show();
                    Users users = new Users(email,UserID,identitymno);
                    databaseReference.child(UserID).setValue (users);
//
                    startActivity(new Intent(SignUp.this,barcodein2.class));
